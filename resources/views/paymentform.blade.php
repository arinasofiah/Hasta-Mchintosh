...
<div class="container">
    ...
    <div class="section">
        ...
        <div class="total-row">Deposit Payable : MYR {{ number_format($deposit, 2) }}</div>
        <div class="total-row">Total Payable : MYR {{ number_format($finalTotal, 2) }}</div>
    </div>
    ...
    <div class="section">
        ...
        <div class="qr-section">
            ...
            <div class="qr-code">
                @if(file_exists(public_path('storage/qrImage.jpeg')))
                    <img src="{{ asset('storage/qrImage.jpeg') }}">
                @else
                    <div style="color:#999;">QR Code Not Available</div>
                @endif
            </div>
