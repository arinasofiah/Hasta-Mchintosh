    ...
    <div class="content-with-sidebar">
        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('booking.history') }}" class="active">
                        My Bookings
                    </a>
                </li>
                    ...
                    @forelse($pending as $booking)
                        ...
                        <div class="booking-card">
                            <div class="booking-details">
                                ...
                                <div class="price">RM{{ number_format($rentalPrice + 50, 2) }}</div>
...
function showDetailsModal(bookingId) {
    ...
    // Use duration field
    // Removed the duration field since it's commented in HTML
...
document.addEventListener('click', function(e) {
    ...
    if (e.target.closest('button') && (e.target.closest('button').textContent.includes('Details') || 
        e.target.closest('button').textContent.includes('View') ||
        e.target.closest('button').innerHTML.includes('fa-eye'))) {
    ...
    if (e.target.closest('button') && (e.target.closest('button').textContent.includes('Cancel') || 
        e.target.closest('button').innerHTML.includes('fa-times'))) {
