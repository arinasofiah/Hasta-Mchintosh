...
<html lang="en">
<head>
    <title>Hasta - Verify Return</title>
...
<div class="container">
    <div class="page-header">
        ...
        <h1 class="page-title">Verify Return Vehicle</h1>
    </div>
        ...
        <table class="custom-table">
            <thead>
                <tr>
                    ...
                    <th>Date</th>
                    <th>Customer Name</th>
                    <th class="text-center">Proof Of Return</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($booking->endDate)->format('d-m-Y') }}</td>
                ...
                @empty
                <tr><td colspan="5" class="text-center p-4">No active returns.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
