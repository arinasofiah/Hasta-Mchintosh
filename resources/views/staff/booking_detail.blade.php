        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>Booking Details #{{ $bookings->bookingID }}</span>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="value">{{ $bookings->customer->name ?? 'N/A' }}</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="label">Email</div>
                            <div class="value">{{ $bookings->customer->email ?? 'N/A' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="value">{{ $bookings->pickupDate }}</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="label">Return Date</div>
                            <div class="value">{{ $bookings->returnDate }}</div>
                        </div>
                        <div class="col-md-12">
                            <div class="label">Total Price</div>
                            <div class="value" style="font-size: 18px; color: #E85D04; font-weight: 700;">
                                RM {{ number_format($bookings->totalPrice, 2) }}
                            </div>
                        </div>
                    </div>
